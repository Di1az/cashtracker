...
import { useForm } from "@inertiajs/react" //Hook de Inertia para trabajar con forms
import Ziggy from '@/ziggy' 
import { route } from 'ziggy-js' //Configurando Ziggy JS para rutas de Laravel en JavaScript
...
export default function ExpenseForm() {
    ...
    const submit = (e: React.SubmitEvent<HTMLFormElement>) => {
        ...
        //Usando Ziggy JS para rutas de Laravel en JavaScript
        ...
        <div className='p-10 flex justify-center'>
            <form onSubmit={submit} className='flex flex-col space-y-3 w-full'>
                ...
                <button 
                    disabled={processing} 
                    type="submit" 
                    className={`${processing ? ' opacity-60 cursor-not-allowed' : ' hover:bg-purple-800 cursor-pointer'}
